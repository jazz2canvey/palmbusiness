...
public class LoginModel {
	...
	address_pincode, phone, email_main, password, email_ccc, website, gst_scheme_id, composition_charge, gstin;

	public LoginModel() {
		
	}
	
	public LoginModel(String enterprise_id, String enterprise_logo, String enterprise_name, String fiscal_year, String date_format, String address_street_1, String address_street_2, String address_city, String address_state, String address_country, String address_pincode, String phone, String email_main, String password, String email_ccc, String website, String gst_scheme_id, String composition_charge, String gstin) {
	...
	public String getComposition_charge() {
		return composition_charge;
	}

	public void setComposition_charge(String composition_charge) {
		this.composition_charge = composition_charge;
	}
